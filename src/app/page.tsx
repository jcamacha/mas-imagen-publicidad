...
export default function Home() {
  // Stat numbers counter animation & WhatsApp float animation
  useEffect(() => {
    // 1. WhatsApp Float animation
    ...
    const section = document.querySelector(".border-why-us");
    if (section) {
  ...
  const handleIconHover = (selector: string) => {
    animate(selector, {
      rotate: [0, 360],
      duration: 800,
        ...
        <section className="py-20 md:py-28 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 space-y-6 text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#c4b840] text-text text-xs font-semibold tracking-wider font-manrope origin-left"
            >
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-tight font-fraunces flex flex-wrap gap-x-[0.3em] gap-y-[0.1em]"
            >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                onMouseEnter={() => handleIconHover(".icon-web")}
                className="p-8 flex flex-col justify-between rounded-2xl bg-surface border border-border"
              >
                <div>
                  <div className="w-10 h-10 mb-6 flex items-center justify-center rounded-xl bg-accent-light text-text service-icon icon-web">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
                onMouseEnter={() => handleIconHover(".icon-ads")}
                className="p-8 flex flex-col justify-between rounded-2xl bg-surface border border-border"
              >
                <div>
                  <div className="w-10 h-10 mb-6 flex items-center justify-center rounded-xl bg-accent-light text-text service-icon icon-ads">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
                onMouseEnter={() => handleIconHover(".icon-print")}
                className="p-8 flex flex-col justify-between rounded-2xl bg-surface border border-border"
              >
                <div>
                  <div className="w-10 h-10 mb-6 flex items-center justify-center rounded-xl bg-accent-light text-text service-icon icon-print">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      viewBox="0 0 24 24"
        ...
        <section className="py-20 md:py-24 px-6 border-t border-[#c4b840]">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto border-why-us"
            >
              {/* Columna 1 */}
              <motion.div
                ...
                className="bg-bg border border-border p-8 rounded-2xl flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-accent-light text-text">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <div className="text-4xl font-extrabold font-fraunces text-text">
                      <span className="stat-number" data-target="12">0</span>
                      <span className="text-xl font-bold font-sans ml-0.5">años</span>
                    </div>
                  </div>
                  <h3 className="text-xl font-bold font-fraunces mb-3 text-text">
                    Taller propio
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-4xl font-extrabold font-fraunces text-text">
                      ...
                      <span className="text-xl font-bold font-sans ml-0.5">en 1</span>
                    </div>
                  </div>
                  <h3 className="text-xl font-bold font-fraunces mb-3 text-text">
                    Digital + físico
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="text-4xl font-extrabold font-fraunces text-text">
                      ...
                      <span className="text-xl font-bold font-sans ml-0.5">%</span>
                    </div>
                  </div>
                  <h3 className="text-xl font-bold font-fraunces mb-3 text-text">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <div className="space-y-3">
              <motion.h2
                ...
                className="text-3xl sm:text-4xl font-bold font-fraunces text-white"
              >
                ¿Empezamos?
              </motion.h2>
            ...
            <div className="space-y-2 pt-4">
              ...
              <a
                ...
                className="whatsapp-float inline-flex items-center gap-2 text-[#fff9c2] hover:text-white font-semibold font-manrope transition-colors"
              >
